...
export async function generateMetadata({
  ...
  return {
    ...
    // photograph.
    // X prints this title in a dark box over the picture, so it appears twice:
    // once in the headline drawn on the card, once here. The newsroom was shown
    // both and asked for the Latin title in that box — X will always print
    // something there, so the choice is Latin or Thaana, never neither.
    twitter: { card: 'summary_large_image', title: textTitle },
  };
}
